...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Rematch'
        db.create_table(u'game_rematch', (
            ('game', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['game.Game'], unique=True, primary_key=True)),
            ('p1_click', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('p2_click', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'game', ['Rematch'])


    def backwards(self, orm):
        # Deleting model 'Rematch'
        db.delete_table(u'game_rematch')
