...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Game.channel'
        db.delete_column(u'game_game', 'channel')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Game.channel'
        raise RuntimeError("Cannot reverse this migration. 'Game.channel' and its values cannot be restored.")
