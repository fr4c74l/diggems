...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FacebookRequest'
        db.create_table(u'game_facebookrequest', (
            ...
            ('targets', self.gf('djorm_pgarray.fields.ArrayField')(default=None, dbtype='text', null=True, blank=True)),
        ))
        db.send_create_signal(u'game', ['FacebookRequest'])


    def backwards(self, orm):
        # Deleting model 'FacebookRequest'
        db.delete_table(u'game_facebookrequest')
